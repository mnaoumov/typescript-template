 ...
 *    files against this repo's 12 - and was byte-identical here on every shared file but one, so it is the
 *    natural side to compare against. `obsidian-typings/obsidian-typings-crawler` carries the same helpers and
