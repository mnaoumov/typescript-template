 ...
 *
 * This repo resolves no dependency on `obsidian-dev-utils` - it is a template, not a consumer - so the
 ...
 * moving underneath a tree nobody touches is invisible to a hook. Four of the five sibling repos that carry
 * this gate run it from the hook alone; `obsidian-typings` and this template also run it in CI, and that is
 * the shape a repo scaffolded from here inherits.
 *
